...
module.exports = async (message, parameters) => {
    ...
    for await (let [index, suppliedParameter] of messageParameters.entries()) {
        ...
        if(commandParameter.type === "Argument" || commandParameter.type === "Argument" ) {
            ParsedCommandParameters.push(new Argument(suppliedParameter));
        } else if (commandParameter.type === "GuildMember") {
